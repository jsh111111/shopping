...
<body>
	<div class="container mt-3">
		...
		<h2>
			<i class="fa-solid fa-user"></i> 회원가입 <small>(<span id="need">*</span>
				필수입력사항)
			</small>
		</h2>
		<br>
		...
		<form action="create" method="post" name='frm'
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" size="10" name="zipcode"
