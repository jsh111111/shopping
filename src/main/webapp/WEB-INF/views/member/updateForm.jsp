...
<body>
	<div class="container mt-3">
		...
		<h3>
			정보 수정 <small>(<span id="need">*</span> 필수입력사항)
			</small>
		</h3>
		<form action="/member/update" method="post" name='frm'
			onsubmit="return inCheck(this)" style="width: 80%">
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" id="sample6_address"
					value="${dto.address1}" name="address1">
			</div>
			...
			<div class="input-group m-3">
				...
				<button type="reset" class="btn btn-outline-dark" onclick="location.href='/admin/member/list'">취소</button>
			</div>
		</form>
